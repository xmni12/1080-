...
import { Save, Settings2, Loader2, Download, UploadCloud, Trash2, Cpu, ShieldCheck, DatabaseBackup } from 'lucide-react';
...
export function Settings() {
  ...
  const [activeTab, setActiveTab] = useState<'sections' | 'advanced' | 'maintenance'>('sections');
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      {/* Tabs Navigation */}
      <div className="flex space-x-1 bg-white p-1 rounded-xl shadow-sm border border-slate-100">
        <button
          onClick={() => setActiveTab('sections')}
          className={clsx(
            "flex-1 flex items-center justify-center gap-2 py-3 px-4 text-sm font-semibold rounded-lg transition-all",
            activeTab === 'sections' ? "bg-primary text-white shadow-md" : "text-slate-500 hover:text-slate-700 hover:bg-slate-50"
          )}
        >
        ...
        <button
          ...
          className={clsx(
            "flex-1 flex items-center justify-center gap-2 py-3 px-4 text-sm font-semibold rounded-lg transition-all",
            activeTab === 'advanced' ? "bg-purple-600 text-white shadow-md" : "text-slate-500 hover:text-slate-700 hover:bg-slate-50"
          )}
        >
        ...
        <button
          ...
          className={clsx(
            "flex-1 flex items-center justify-center gap-2 py-3 px-4 text-sm font-semibold rounded-lg transition-all",
            activeTab === 'maintenance' ? "bg-rose-500 text-white shadow-md" : "text-slate-500 hover:text-slate-700 hover:bg-slate-50"
          )}
        >
          ...
          {['4k', 'vr', 'hd', 'sub'].map(section => (
            <div key={section} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">历史进度 (断点续传水位线)</label>
                  <input 
                    type="number" 
      ...
      {activeTab === 'maintenance' && (
        <div className="space-y-6 animate-in slide-in-from-bottom-2 fade-in duration-300">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 border-l-4 border-l-slate-400">
              <h4 className="font-semibold text-slate-800 mb-4 flex items-center gap-2 border-b border-slate-100 pb-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button 
                    ...
                    className="flex items-center justify-center gap-3 bg-slate-50 border border-slate-200 hover:bg-slate-100 hover:text-slate-800 text-slate-700 px-6 py-4 rounded-xl font-medium transition-all shadow-sm"
                  >
                  ...
                  <div className="relative">
                      <input 
                        ...
                        title="点击选择备份文件上传"
                      />
                      <button className="w-full flex items-center justify-center gap-3 bg-slate-50 border border-slate-200 hover:bg-slate-100 hover:text-slate-800 text-slate-700 px-6 py-4 rounded-xl font-medium transition-all shadow-sm pointer-events-none">
